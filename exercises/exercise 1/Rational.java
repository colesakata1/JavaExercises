...
public class Rational {
    ...
    public Rational add(Rational other) {
        if (other.x == 0) {
            ...
            return new Rational(other.x, other.y);
        } else {
            return new Rational(other.x * this.y + other.y * this.x, this.y * other.y);
    ...
    public boolean equals(Object other) {
        if (this.getClass() == other.getClass()) {
            return (((Rational) other).x == this.x && ((Rational) other).y == this.y);
        } else {
            return false;
        }
